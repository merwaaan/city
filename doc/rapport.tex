...
\begin{figure}[H]
  \centering
  \subcaptionbox{Ville virtuelle.}[.4\linewidth][c]{
    \includegraphics[width=.4\linewidth]{images/vf-base.png}
  }
  \subcaptionbox{Champ d'évasion de la densité.}[.4\linewidth][c]{
    \includegraphics[width=.4\linewidth]{images/vf-density.png}
  }

  \subcaptionbox{Champ d'attraction des routes}[.4\linewidth][c]{
    \includegraphics[width=.4\linewidth]{images/vf-road.png}
  }
  \subcaptionbox{Champ de répulsion des obstacles}[.4\linewidth][c]{
