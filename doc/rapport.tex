...
\begin{figure}[!ht]
  ...
  \subcaptionbox{La ville.}[.4\linewidth][c]{
    %\includegraphics[width=.3\linewidth]{images/field_base.png}
  }
  \subcaptionbox{Le champ d'évasion de la densité.}[.4\linewidth][c]{
    %\includegraphics[width=.3\linewidth]{images/field_density.png}
  }

  \subcaptionbox{Le champ d'attraction des routes}[.4\linewidth][c]{
    %\includegraphics[width=.3\linewidth]{images/field_road.png}
  }
  \subcaptionbox{Le champ de répulsion des obstacles}[.4\linewidth][c]{
    %\includegraphics[width=.3\linewidth]{images/field_obstacles.png}
  }

  \subcaptionbox{Le champ de vecteurs global.}[.8\linewidth][c]{
    %\includegraphics[width=.3\linewidth]{images/field_sum.png}
  }
  \caption{}
  \label{fig:fields}
\end{figure}
