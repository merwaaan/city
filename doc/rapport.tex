...
structure permettant de représenter à la fois le bâti et le viaire. On
propose à cet effet d'utiliser le diagramme de Voronoï.
...
bâtiments, et donc aux routes potentielles. Ainsi, chaque cellule de
Voronoï représente l'espace d'une parcelle tandis que chaque arête est
une voie potentiellement constructible.
...
n'en déborde pas ou à l'opposé qu'elle représente une minuscule
fraction de sa surface. C'est notamment remarquable aux bords de
l'environnement de la simulation puisque les parcelles situées à la
frontière de la ville sont contenues dans des cellules de Voronoï
immenses BLABLA.
...
représentent. Autrement dit, une telle arête décrit qu'une voie
passent entre deux bâtiments précis sans pour autant renseigner sur sa
