...
la prétention de cette tentative n'est bien sûr pas d'émuler le
développement complet du Havre à partir d'un des ces sous-ensembles
mais plutôt de partir d'une configuration existante et obéissant donc
??? puis d'observer le comportement de la simulation. Chaque ville est
unique et évolue dans un cadre différent. Dans notre représentation du
Havre, la contrainte la plus apparente provient du profil côtier qui
interdit tout développement de la ville dans cette direction. Cette
limitation nous permet de mettre en application notre évitement des
obstacles via un champ de vecteurs approprié. On observe que la
configuration initiale comprend un unique centre dense. À l'issu de la
simulation, il devrait s'être élargi. D'autres centres pourront être
apparu. On prévoit aussi une expansion du territoire urbain vers le
nord, le nord-est et l'est.
