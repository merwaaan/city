...
ses alentours. L'ensemble des éléments construits forme la ville.
...
Cette dualité et cette unidirectionnalité sont justifiées par un désir
de fournir un modèle historiquement fidèle. On ne se contente pas de
...
décrire sa croisance de façon logique.
...
\item{On construit une route pour permettre l'installation de la
  nouvelle parcelle;}
...
Le mécanisme de placement des élément potentiels se base sur les
variables internes au système urbain dont l'évolution est régie par le
mécanisme cellulaire. Ce troisième mécanisme choisit quels éléments
potentiels sont construits. On traite différemment le choix des routes
à construire et le choix des parcelles à construire.
